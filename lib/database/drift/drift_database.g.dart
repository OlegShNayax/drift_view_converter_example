...
class DriftMachineViewData extends DataClass {
    ...
    return DriftMachineViewData(
      ...
      main: $DriftMachineInfoTableTable.$converter0.mapToDart(const StringType()
          .mapFromDatabaseResponse(
              data['${effectivePrefix}machine_info.main'])),
      details: $DriftMachineInfoTableTable.$converter1.mapToDart(
          const StringType().mapFromDatabaseResponse(
              data['${effectivePrefix}machine_info.details'])),
    );
  }
  factory DriftMachineViewData.fromJson(Map<String, dynamic> json,
    ...
    return DriftMachineViewData(
      ...
      main: serializer.fromJson<Main?>(json['main']),
      details: serializer.fromJson<Details?>(json['details']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'main': serializer.toJson<Main?>(main),
      'details': serializer.toJson<Details?>(details),
    };
  }
...
abstract class _$DriftDatabaseImpl extends GeneratedDatabase {
  ...
  late final DriftMachineDao driftMachineDao =
      DriftMachineDao(this as DriftDatabaseImpl);
  @override
